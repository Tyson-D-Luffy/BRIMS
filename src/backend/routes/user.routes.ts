...
router.get("/", authenticateToken, authorizeRoles(["ADMIN", "QA"]), UserController.getAll);
router.get("/:id", authenticateToken, authorizeRoles(["ADMIN", "QA"]), UserController.getById);
